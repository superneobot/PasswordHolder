...
namespace InputBoxdlg
{
    ...
    public class InputBox
    {
        ...
        private static void InitializeComponent()
        {
            ...
            btnOK.Location = new Point(106, 60);
            btnOK.Name = "btnOK";
            ...
            btnCancel.Location = new Point(176, 60);
            ...
            txtInput.Size = new Size(230, 20);
            txtInput.TabIndex = 0;
            txtInput.Text = "";
            txtInput.KeyDown += new KeyEventHandler(EnterPress);
            // 
            // InputBoxDialog
            // 
            frmInputDialog.AutoScaleBaseSize = new Size(5, 13);
            frmInputDialog.ClientSize = new Size(250, 90);
        ...
        static private void EnterPress(object sender, KeyEventArgs e)
        {
